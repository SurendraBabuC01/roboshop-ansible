pipeline {
    ...
    parameters {
        ...
        string(name: 'force_schema_reload', defaultValue: 'false', description: 'Provide the true or false')
    }
    ...
    stages {
        ...
        stage('Ansible') {
            steps {
                ...
                sh 'ansible-playbook -i /tmp/inv roboshop.yml -e ansible_user=centos -e ansible_password=DevOps321 -e env=${env} -e role_name=${component} -e force_schema_reload=${force_schema_reload}'
            }
        }
